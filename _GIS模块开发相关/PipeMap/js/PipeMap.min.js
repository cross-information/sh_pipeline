...
function PipeMap(x,L,M,y){function z(a){a?(A=!0,$("#"+x+" #anchorLayer").show(),a="string"==typeof a?a:"ic_markdown_entity",$("#anchorMark").attr("src","img/"+a+".png"),a=h.getView().calculateExtent(h.getSize()),u=[.5*(a[0]+a[2]),.5*(a[1]+a[3])]):(A=!1,$("#"+x+" #anchorLayer").hide())}function F(){if("undefined"!=typeof f&&"undefined"!=typeof n){var a=[];for(e in f){var b=f[e];b.coords=l[e]||b.coords;var d=new ol.Feature({geometry:new ol.geom.Point(b.coords)});d.setId(b.id);d.setProperties({name:b.name,
location:b.location});r==b.id&&d.setStyle(t[0]);b.feature=d;b.pipes=[];a.push(d)}if(0==a.length)v.setVisible(!1);else{d=v.getSource();d.clear();d.addFeatures(a);a=[];for(var c in n){var e=n[c];d=f[e.startWellId];d.pipes.push(c);b=f[e.endWellId];b.pipes.push(c);d=new ol.Feature({geometry:new ol.geom.LineString([d.coords,b.coords])});d.setId(e.id);d.setProperties({name:e.name,location:e.location});e.feature=d;a.push(d)}d=G.getSource();d.clear();d.addFeatures(a)}}}function H(){var a=h.getView().calculateExtent(h.getSize());
5<=h.getView().getZoom()&&!isNaN(a[0]+a[1]+a[2]+a[3])&&(n=f=void 0,$.get({url:M+"/QueryPipe.ashx",success:function(a){f=a.wells;F();n=a.pipes;F()},dataType:"json"}))}function I(){return 0<=e}function J(){return e<g.length-1}y=y||{};var k,w=new ol.Feature({geometry:new ol.geom.Point([110.936163514853,21.664131939419])}),c=new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/teotb.png"})});w.setStyle(c);w=new ol.Feature({geometry:new ol.geom.Point([110.936163514853,
21.664131939419])});var t=[];t[0]=new ol.style.Style({image:new ol.style.Circle({radius:5,snapToPixel:!1,fill:new ol.style.Fill({color:"rgb(255, 0, 0)"}),anchor:[10,10]}),anchor:[10,10]});t[1]=new ol.style.Style({image:new ol.style.Circle({radius:5,snapToPixel:!1,fill:new ol.style.Fill({color:"rgb(0, 0, 255)"})})});w.setStyle(t[0]);new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/teotb.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[8,
8],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/teodf.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/tegjjx.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/tegfqh.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/tegzdh.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,
14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/tebuilding.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/teproblem.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/teotbyellow.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/n.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,
14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/teotbgreen.png"})});new ol.style.Style({image:new ol.style.Icon({anchor:[11.5,14],anchorXUnits:"pixels",anchorYUnits:"pixels",src:"img/teotbred.png"})});var v=new ol.layer.Vector({source:new ol.source.Vector({features:[]}),style:t[1]}),G=new ol.layer.Vector({source:new ol.source.Vector({features:[]})});w=new ol.layer.Vector({source:new ol.source.Vector({features:[w]}),visible:!1});var A=!1,u,p=-1,B=null,l={},g=[],e=-1,f=void 0,n=void 0,C=null;
c=new ol.proj.Projection({code:"EPSG:21481",extent:[-202675.555626,-114341.002031999,191025.231774999,141247.009144004],units:"m"});ol.proj.addProjection(c);c=location.hash;if(1<c.length){var q=c.indexOf(":");c=c.substr(0<q?q+1:1);(c=c.split(","))&&4==c.length&&(c[0]=parseFloat(c[0]),c[1]=parseFloat(c[1]),c[2]=parseFloat(c[2]),c[3]=parseFloat(c[3]),isNaN(c[0]+c[1]+c[2]+c[3]))}q=new ol.interaction.Select({layers:[v],style:t[0]});var D=null;q.on("select",function(a){if(D&&0<a.selected.length){if(r&&
f){var b=f[r];b&&b.feature.setStyle(null)}r=a.selected[0].getId();D(r);r&&f&&(b=f[r])&&b.feature.setStyle(t[0])}});var E=null;c=new ol.interaction.Translate({layers:[v]});c.on("translatestart",function(a){if(0<a.features.getLength()&&f){a=a.features.item(0).getId();var b=f[a];e<g.length-1&&(g=0<=e?g.slice(0,e+1):[]);g.push({wellId:a,coords0:[b.coords[0],b.coords[1]],coords1:[b.coords[0],b.coords[1]]})}});c.on("translating",function(a){if(0<a.features.getLength()&&f){var b=a.features.item(0).getId();
l[b]=a.coordinate;b=f[b];b.coords=a.coordinate;for(a=0;a<b.pipes.length;a++){var d=n[b.pipes[a]];d.feature.setGeometry(new ol.geom.LineString([f[d.startWellId].coords,f[d.endWellId].coords]))}}});c.on("translateend",function(a){if(0<a.features.getLength()&&f){var b=a.features.item(0).getId();e=g.length-1;0<=e&&(g[e].coords1=[a.coordinate[0],a.coordinate[1]]);E&&E(b,a.coordinate)}});q=[q];y.noTranslate||q.push(c);var h=new ol.Map({controls:[new ol.control.Zoom],interactions:ol.interaction.defaults().extend(q),
logo:!1,target:x,layers:[new ol.layer.Tile({source:new ol.source.TileArcGISRest({url:L,logo:!1})}),G,v,w],view:k=new ol.View({projection:"EPSG:21481",resolutions:[529.167725002117,264.583862501058,185.208703750741,132.291931250529,66.1459656252646,31.750063500127,15.8750317500635,7.93751587503175,3.96875793751588,2.11667090000847,1.05833545000423,.529167725002117,.264583862501058,.132291931250529],center:[-5825.16,8293.31],zoom:10,enableRotation:!1})});var r=void 0;h.on("moveend",function(a){var b=
a.map;a=b.getView();b=a.calculateExtent(b.getSize());a.getCenter();var d=ol.extent.getBottomLeft(b),c=ol.extent.getTopRight(b);C&&C(d.join(",")+","+c.join(",")+","+a.getZoom());A&&(u=[.5*(b[0]+b[2]),.5*(b[1]+b[3])],0<=p&&(l[p]=u));H()});m&&m.parentNode.removeChild(m);var m=document.createElement("div");m.className="tooltip tooltip-measure";var K=new ol.Overlay({element:m,offset:[0,-15],positioning:"bottom-center"});h.addOverlay(K);h.on("pointermove",function(a){if(a.dragging)m.classList.add("hidden");
else{var b=h.getEventPixel(a.originalEvent);if(b=h.forEachFeatureAtPixel(b,function(a){return a})){var d=[];b.getGeometry()instanceof ol.geom.Point?(d.push("\u7ba1\u4e95ID: "+b.getId()),d.push("\u7ba1\u4e95\u540d\u79f0: "+b.get("name")),d.push("\u7ba1\u4e95\u4f4d\u7f6e: "+b.get("location"))):(d.push("\u7ba1\u9053ID: "+b.getId()),d.push("\u7ba1\u9053\u540d\u79f0: "+b.get("name")),d.push("\u7ba1\u9053\u4f4d\u7f6e: "+b.get("location")));m.innerHTML=d.join("<br/>");K.setPosition(a.coordinate);m.classList.remove("hidden")}else m.classList.add("hidden")}});
$(h.getViewport()).append('<div id="anchorLayer" style="position:absolute;left:50%;top:50%;margin-left:width/2;margin-top:height/2;z-index:100;display:none;"><img id="anchorMark" src="img/ic_markdown_entity.png" style="position:relative;left:-24px;top:-48px"></div>');$("#"+x+" #anchorLayer").click(function(){0<=p&&(l[p]=u,e=g.length-1,0<=e&&(g[e].coords1=u),B&&B(p,u),z(!1),p=-1)});return{map:h,wellLayer:v,position:z,setCenter:function(a){k&&(console.log("setCenter("+a[0]+", "+a[1]+");"),k.setCenter(a))},
setZoom:function(a){k&&(console.log("setZoom("+a+");"),k.setZoom(a))},getZoom:function(){return k?k.getZoom():-1},getExtent:function(){return h.getView().calculateExtent(h.getSize())},zoomIn:function(){k&&k.setZoom(k.getZoom()+1)},zoomOut:function(){k&&k.setZoom(k.getZoom()-1)},setSelectCallback:function(a){D=a},setDragCallback:function(a){E=a},setMapExtentCallback:function(a){C=a},setEditWellCallback:function(a){B=a},wellUpdatesHistory:g,getWellUpdatesHistoryIndex:function(){return e},undo:function(){if(I()){for(var a=
g[e--],b=a.wellId,d=0,c=0;c<=e;c++)if(g[c].wellId==b){d++;break}0<d?l[b]=a.coords0:delete l[b];b=f[b];b.coords=a.coords0;b.feature.setGeometry(new ol.geom.Point(b.coords));for(c=0;c<b.pipes.length;c++)a=n[b.pipes[c]],a.feature.setGeometry(new ol.geom.LineString([f[a.startWellId].coords,f[a.endWellId].coords]))}},redo:function(){if(J()){var a=g[++e],b=a.wellId;l[b]=a.coords1;b=f[b];b.coords=a.coords1;b.feature.setGeometry(new ol.geom.Point(b.coords));for(a=0;a<b.pipes.length;a++){var c=n[b.pipes[a]];
c.feature.setGeometry(new ol.geom.LineString([f[c.startWellId].coords,f[c.endWellId].coords]))}}},canUndo:I,canRedo:J,getWellUpdates:function(){return l},clearWellUpdates:function(){l={};g=[];e=-1},editWell:function(a){var b=f[a];b&&(p=a,l[p]=h.getView().getCenter(),e<g.length-1&&(g=0<=e?g.slice(0,e+1):[]),g.push({wellId:a,coords0:[b.coords[0],b.coords[1]],coords1:[b.coords[0],b.coords[1]]}),z(!0),H())}}};
