...
namespace Slickflow.Engine.Business.Manager
{
    ...
    internal class TransitionInstanceManager : ManagerBase
    {
            ...
            String processGUID)
        {
            ...
            var sql = @"SELECT 
                            T.* 
                        FROM GXSYS.GX_WfTransitionInstance T
                        INNER JOIN GXSYS.GX_WfActivityInstance A
        ...
        {
            var sql = @"SELECT * FROM GXSYS.GX_WfTransitionInstance 
        ...
        {
            var whereSql = @"SELECT * FROM GXSYS.GX_WfTransitionInstance 
                        WHERE AppInstanceID=@appInstanceID 
                            AND ProcessGUID=@processGUID 
